...
public class ZipCodeTest {
    ...
    @Test(description = "Test from class (4 digits instead of 5)")
    public void test1() {
    ...
    @Test(description = "7 digits instead of 5")
    public void test2() {
    ...
    @Test(description = "Send empty field")
    public void test3() {
    ...
    @Test(description = "Send chars instead of digits")
    public void test4() {
    ...
    @Test(description = "Valid data (5 digits)")
    public void test5() {
        ...
        browser.findElement(By.cssSelector("[value = Continue]")).click();
        boolean isRegisterFormVisible = browser.findElement(By.cssSelector("[value = Register]")).isDisplayed();
        Assert.assertTrue(isRegisterFormVisible);
        browser.quit();
    }
}
